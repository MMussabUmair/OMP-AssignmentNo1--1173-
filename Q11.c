// Parallel(Reduction, Static Scheduling with 4 threads) with chunk size 400
...
//Sum=0.003776+0.004390+0.003389+0.005863+0.004087+0.008791+0.004287+0.004118+0.003665+ 0.003373
//Average = sum / 10
//Average = 0.004574
